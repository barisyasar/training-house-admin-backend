export const ALL_FOURS_SQUAD_STRETCH_RIGHT = {
  exerciseId: 'all-fours-squad-stretch-right',
  isSided: 'none',
  type: 'exercise',
  ...
  translations: [
    {
      locale: 'en-US',
      name: 'All Fours Squad Stretch (Right)',
    ...
    {
      locale: 'tr-TR',
      name: 'Dört Ayak Çömelme Germe (Sağ)',
  ...
  gif: {
    1: 'all-fours-squad-stretch-right_1.gif',
    2: 'all-fours-squad-stretch-right_2.gif',
    3: 'all-fours-squad-stretch-right_3.gif',
    4: 'all-fours-squad-stretch-right_4.gif',
  },

  createdAt: '2025-09-23T12:18:10.716Z',
};

export default ALL_FOURS_SQUAD_STRETCH_RIGHT;
