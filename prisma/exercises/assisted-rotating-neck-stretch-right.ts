export const ASSISTED_ROTATING_NECK_STRETCH_RIGHT = {
  exerciseId: 'assisted-rotating-neck-stretch-right',
  isSided: 'none',
  type: 'exercise',
  ...
  translations: [
    {
      locale: 'en-US',
      name: 'Assisted Rotating Neck Stretch (Right)',
    ...
    {
      locale: 'tr-TR',
      name: 'Destekli Boyun Döndürme Germe (Sağ)',
...
export default ASSISTED_ROTATING_NECK_STRETCH_RIGHT;
