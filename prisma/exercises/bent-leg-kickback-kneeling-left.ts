export const BENT_LEG_KICKBACK_KNEELING_LEFT = {
  exerciseId: 'bent-leg-kickback-kneeling-left',
  isSided: 'none',
  type: 'exercise',
  ...
  translations: [
    {
      locale: 'en-US',
      name: 'Kneeling Bent Leg Kickback (Left)',
    ...
    {
      locale: 'tr-TR',
      name: 'Diz Üstü Bükülü Bacak Geri Tekme (Sol)',
  ...
  gif: {
    '180': 'bent-leg-kickback-kneeling-left-180.gif',
    '360': 'bent-leg-kickback-kneeling-left-360.gif',
    '720': 'bent-leg-kickback-kneeling-left-720.gif',
    '1080': 'bent-leg-kickback-kneeling-left-1080.gif',
  },

  createdAt: '2025-09-23T12:18:10.722Z',
};

export default BENT_LEG_KICKBACK_KNEELING_LEFT;
